...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $em)
  {
    ...
    $job_sensio_labs->setDescription('Lorem ipsum dolor sit amet, consectetur adipisicing elit.');
    $job_sensio_labs->setHowToApply('Send your resume to lorem.ipsum [at] dolor.sit');
    ...
    $job_sensio_labs->setCreatedAt(new \DateTime('2015-04-01'));
    ...
    $job_extreme_sensio->setExpiresAt(new \DateTime('2015-03-25'));
